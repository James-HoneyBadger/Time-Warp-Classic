...
class TimeWarpInterpreter:
    def __init__(self, output_widget=None):
        ...
        self.ruby_executor = RubyExecutor(self)
    ...
    def set_language_mode(self, mode):
        ...
        valid_modes = ["pilot", "basic", "logo", "python", "javascript", "perl", "ruby"]
    ...
    def execute_line(self, line):
        ...
        if cmd_type == "pilot":
            ...
            return self.ruby_executor.execute_command(command)
